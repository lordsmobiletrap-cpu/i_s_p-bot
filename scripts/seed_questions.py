"""
Script to seed the topics table with IELTS Speaking Part 2 questions.
...
Requires DB_PATH in .env (default: ielts_bot.db).
"""
...
from services.database import Database, TopicRepository
...
async def main() -> None:
    ...
    added = await repo.seed_from_list(QUESTIONS)

    if added:
        print(f"✅ Added {added} new question(s) to the database.")
    else:
